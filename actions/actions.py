...
class ExcelDataHandler:
    ...
    def _start_refresh(self):
        def refresh():
            self._load_data()
            threading.Timer(600, refresh).start()
        refresh()
...
class ResponsePipeline:
    ...
    def _start_with_excel(self, query: str) -> str:
        ...
        self.conversation_history = [
            {"role": "system", "content": "You are a helpful assistant using this Excel data to answer user queries and your company name was Super Skill and you are developed by J Sanjay Ram and your name was Qbee."},
